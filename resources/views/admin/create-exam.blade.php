...
@section('admin-content')
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal form-material mx-2" action="{{route('manageexams.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number"
                                       class="form-control ps-0 form-control-line" name="time"  value="{{old('time')}}" placeholder="exam time in hours" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number"
                                       class="form-control ps-0 form-control-line" name="exam_mark"  value="{{old('exam_mark')}}" placeholder="exam exam_mark to be compared" required>
                            </div>
                        </div>
                        <div class="form-group">
