...
@section('admin-content')
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal form-material mx-2" action="{{route('manageques.update',$question->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="textarea"
                                       class="form-control ps-0 form-control-line" name="second"  value="{{$question->second}}" placeholder="text">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number"
                                       class="form-control ps-0 form-control-line" name="mark"  value="{{$question->mark}}" placeholder="number" required>
                            </div>
                        </div>
                        <div class="form-group">
